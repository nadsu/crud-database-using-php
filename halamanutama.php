...
<form method="POST" action="input.php"> 
    <table align="center" cellpadding="2" cellspacing="2">
        <h1 id="font1"> SIGN UP </h1>
        <tr>
            <td width="130" style="font-size: 20px;"> Nama </td>
        ...
        <tr>
            <td width="130" style="font-size: 20px;"> Homepage </td>
            <td> <input id="kolom" type="text" name="homepage"> </td>
        </tr>
        <tr>
